...
class HomeController extends Controller
{
    ...
    public function myappoinment(){
        if(Auth::id()){
            $table=appoint::all();
           return view('my_appoinment',compact('table'));
    }
    else{
...
public function getuser(Request $request)
        {
            ...
            return view('getuser')->with(['user' => $user]);
        }
    ...
    */
    ...
    public function appoinment(Request $request)
    {
        ...
        $data->counselor=$request->counselor;
    ...
    public function showappointment(){
        if(Auth::id()){
            $userid=Auth::user()->id;
            $appoint=Appoint::where('userid',$userid)->get();
            $table=appoint::all();
           return view('showappointment',compact('appoint'));
    }
    else{
        return redirect()->back();
    }
