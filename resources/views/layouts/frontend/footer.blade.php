        ...
        <section class="footer text-light">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3 py-4 py-md-5">
                        <div>
                            <h4 class="py-2">Take a test</h4>
                            <div class="d-flex align-items-center py-2">
                                <i class="fas fa-caret-right"></i>
                                <a href="https://www.16personalities.com/free-personality-test" target="_blank"><p class="ms-3">Personality Test</p></a>
                            </div>
                            <div class="d-flex align-items-center py-2">
                                <i class="fas fa-caret-right"></i>
                                <a href="https://www.healthyplace.com/psychological-tests" target="_blank"><p class="ms-3">Psychological Testing</p></a>
                            </div>
                            <div class="d-flex align-items-center py-2">
                                <i class="fas fa-caret-right"></i>
                                <a href="https://www.depression-anxiety-stress-test.org/take-the-test.html" target="_blank"><p class="ms-3">DASS Test</p></a>
                            </div>
                            <div class="d-flex align-items-center py-2">
                                <i class="fas fa-caret-right"></i>
                                <a href="#" target="_blank"><p class="ms-3">Career Counselling</p></a>
                            </div>
                            <div class="d-flex align-items-center py-2">
                                <i class="fas fa-caret-right"></i>
                                <a href="http://www.educationplanner.org/students/self-assessments/learning-styles-quiz.shtml" target="_blank"><p class="ms-3">Learning Style</p></a>
                            </div>
                        </div>
                    </div> <!-- end of col -->
